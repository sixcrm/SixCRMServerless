...
var tests = [{
	name: "index",
	query: "./endpoints/graph/queries/index/getProductSchedules"
},
{
	name: "view",
	query: "./endpoints/graph/queries/view/getProductSchedule"
},
{
	name: "create",
	query: "./endpoints/graph/queries/create/createProductSchedule"
},
{
	name: "update",
	query: "./endpoints/graph/queries/update/updateProductSchedule"
},
{
	name: "delete",
	query: "./endpoints/graph/queries/delete/deleteProductSchedule"
}];
