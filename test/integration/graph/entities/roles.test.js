...
var tests = [{
	name: "index",
	query: "./endpoints/graph/queries/index/getRoles"
},
{
	name: "view",
	query: "./endpoints/graph/queries/view/getRole"
},
{
	name: "create",
	query: "./endpoints/graph/queries/create/createRole"
},
{
	name: "update",
	query: "./endpoints/graph/queries/update/updateRole"
},
{
	name: "delete",
	query: "./endpoints/graph/queries/delete/deleteRole"
}];
