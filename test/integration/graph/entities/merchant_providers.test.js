...
var tests = [{
    name: "index",
    query: global.routes.path('handlers','endpoints/graph/queries/index/getMerchantProviders')
},
{
    name: "view",
    query: global.routes.path('handlers','endpoints/graph/queries/view/getMerchantProvider')
},
{
    name: "create",
    query: global.routes.path('handlers','endpoints/graph/queries/create/createMerchantProvider')
},
{
    name: "update",
    query: global.routes.path('handlers','endpoints/graph/queries/update/updateMerchantProvider')
},
{
    name: "delete",
    query: global.routes.path('handlers','endpoints/graph/queries/delete/deleteMerchantProvider')
}];
