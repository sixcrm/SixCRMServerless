...
let test_name = 'Hero chart timeseries orders vs upsells';
let test_query = global.SixCRM.routes.include('handlers', '/endpoints/graph/queries/analytics/home/hero-chart-timeseries/orders-vs-upsells/by-day.json');
