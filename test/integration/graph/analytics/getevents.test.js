...
let test_query = global.routes.path('handlers','/endpoints/graph/queries/analytics/getEvents');
...
describe('Get '+test_name+' Test', function() {
    ...
    assert.isTrue(tu.validateGraphResponse(response.body, 'analytics/event/listevents'));
