...
var tests = [{
	name: "index",
	query: "./endpoints/graph/queries/index/getShippingReceipts"
},
{
	name: "view",
	query: "./endpoints/graph/queries/view/getShippingReceipt"
},
{
	name: "create",
	query: "./endpoints/graph/queries/create/createShippingReceipt"
},
{
	name: "update",
	query: "./endpoints/graph/queries/update/updateShippingReceipt"
},
{
	name: "delete",
	query: "./endpoints/graph/queries/delete/deleteShippingReceipt"
}];
