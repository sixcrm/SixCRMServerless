INSERT INTO f_product_schedules (transactions_id, datetime, customer, creditcard, merchant_provider, campaign, affiliate, amount, processor_result, account, type, subtype, product_schedule, subaffiliate_1, subaffiliate_2, subaffiliate_3, subaffiliate_4, subaffiliate_5)
  ((
     SELECT
     ...
     SELECT
      ...
      'new',
      'order',
      '12529a17-ac32-4e46-a05b-83862843055d',
      '',
      '',
      '',
      '',
