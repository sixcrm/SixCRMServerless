...
redshiftClient.connect(function(err){
    ...
    redshiftClient.query("copy f_transactions from 's3://"+myBucket+"/"+myKey+"' credentials 'aws_access_key_id=;aws_secret_access_key=' json 'auto' timeformat 'YYYY-MM-DDTHH:MI:SS'"
      , function(err, result){
          if(err) {
