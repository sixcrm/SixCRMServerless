...
//Technical Debt:  Lots of redundancy in these functions
...
class DebugUtilities {
    ...
    deep(){
        ...
        if(_.has(process.env, 'SIX_VERBOSE') && process.env.SIX_VERBOSE > 2){
    ...
    warning(){
        ...
        if(_.has(process.env, 'SIX_VERBOSE') && process.env.SIX_VERBOSE > 0){
    ...
    highlight(){
        ...
        if(_.has(process.env, 'SIX_VERBOSE') && process.env.SIX_VERBOSE > 0){
            ...
            // eslint-disable-next-line no-console
            console.log(chalk.underline.green(output.join("\n")));
    ...
    error(){
        ...
        if(_.has(process.env, 'SIX_VERBOSE') && process.env.SIX_VERBOSE > 1){
            ...
            // eslint-disable-next-line no-console
            console.log(chalk.black.bgYellow(output.join("\n")));
    ...
    info(){
        ...
        if(_.has(process.env, 'SIX_VERBOSE') && process.env.SIX_VERBOSE > 0){
            ...
            // eslint-disable-next-line no-console
            console.log(chalk.blue(output.join("\n")));
