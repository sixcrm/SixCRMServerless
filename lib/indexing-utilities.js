...
class IndexingUtilities {
    ...
    addToSearchIndex(entity){
        ...
        /*
        * Technical Debt:  Shouldn't we short circuit the indexing process right here?
        */
        /*
        ...
        return new Promise((resolve, reject) => {
            ...
            if(!_.has(entity, 'id')){
                ...
                if(!validator.isUUID(entity.id, '4')){
                    ...
                    if(_.has(entity, 'entity_type') && _.contains(['user', 'notificationsetting', 'userdevicetoken', 'usersetting'], entity.entity_type)){
