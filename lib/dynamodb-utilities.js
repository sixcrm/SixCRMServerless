...
*
*
*  DEPRECATED.  Please use dynamodb-utilities-promise.js instead.
*
*
*/
...
class DynamoDBUtilities extends AWSUtilities{
    ...
    createINQueryParameters(field_name, in_array){
      ...
      arrayutilities.isArray(in_array, true);

      if(in_array.length < 1){
        eu.throwError('server', 'in_array is assumed to have length greater than 0');
      }
