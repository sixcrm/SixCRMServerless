...
class FirehoseUtilities {
    ...
    createParametersObject(group_name){
      ...
      /* A.Zelen There is no case translation in Kenisis*/
      ...
      configuration_groups[group_name].forEach((key) => {
        ...
        let discovered_data = objectutilities.recurseByDepth(this.site_config.kinesis, function(p_key){
...
module.exports = new FirehoseUtilities(process.env.stage);
