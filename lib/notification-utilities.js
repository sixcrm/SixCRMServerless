...
const permissionUtils = global.SixCRM.routes.include('lib', 'permission-utilities.js');
...
class NotificationUtilities {
        ...
        return this.validateCreateNotificationObject(create_notification_object).then(() => {
            ...
            users.forEach(user => {
                ...
                let saveOperation = notificationController.create({
                    ...
                    "title": create_notification_object.title,
    ...
    validateCreateNotificationObject(create_notification_object, user_required) {
        ...
        return Promise.resolve(
            mvu.validateModel(create_notification_object, global.SixCRM.routes.path('model', 'actions/create_notification.json')));
