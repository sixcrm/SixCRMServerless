...
class RedshiftQueryUtilities {
  ...
  getConnection() {
      if (this.redshift_is_opened_connection) return Promise.resolve(this.redshift_is_opened_connection);
      return this.openConnection()
        .then((opened_connection) => {
          this.redshift_is_opened_connection = opened_connection;
          this.scheduleQuit();
