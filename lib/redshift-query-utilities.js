...
class RedshiftQueryUtilities {
      ...
      if(errors.length > 0){
          ...
          return global.SixCRM.configuration.getEnvironmentConfig('redshift.host').then((host) => {
              ...
              let pg_config = {
                  ...
                  host: this.redshift_configuration.host ? this.redshift_configuration.host : host,
    ...
    queryRaw(query, parameters) {
        ...
        return new Promise((resolve, reject) => {
          ...
          if(!_.has(this, 'redshift_connection') || !_.isFunction(this.redshift_connection.query)){
    ...
    openConnection(){
      ...
      return new Promise((resolve, reject) => {
        ...
        if(!_.has(this, 'redshift_connection') || !_.isFunction(this.redshift_connection.connect)){
