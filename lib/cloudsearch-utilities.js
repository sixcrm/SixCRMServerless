...
class CloudSearchUtilities extends AWSUtilities {
    ...
    constructor(){
        ...
        this.cloudsearchdomain_endpoint_configuration = {
            development: 'doc-sixcrm-x5xewjrr254yjyrln4mlvxvfm4.us-east-1.cloudsearch.amazonaws.com',
            staging: 'doc-sixcrm-ep6nfe6jetlzhhawthdojiwqtq.us-east-1.cloudsearch.amazonaws.com',
            production: 'doc-sixcrm-ep6nfe6jetlzhhawthdojiwqtq.us-east-1.cloudsearch.amazonaws.com'
        }
    ...
    setCloudsearchDomainEndpoint(){
      ...
      this.cloudsearchdomain_endpoint = this.cloudsearchdomain_endpoint_configuration[global.SixCRM.configuration.stage];
