...
module.exports = class KinesisFirehoseProvider extends AWSProvider {
	...
	validateStreamRecord(validation_model, object) { // eslint-disable-line no-unused-vars

		du.debug('Validate Stream Record');

		// mvu.validateModel(object, global.SixCRM.routes.path('model','analytics/'+validation_model+'.json'));
