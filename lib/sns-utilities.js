...
class SNSUtilities {
    ...
    instantiateSNS(){
      ...
      let sns_region = (objectutilities.hasRecursive(global.SixCRM.configuration.site_config, 'sns.region'))?global.SixCRM.configuration.site_config.sns.region:global.SixCRM.configuration.site_config.aws.region;
      let parameters = {
        apiVersion: 'latest',
        region: sns_region
      };
