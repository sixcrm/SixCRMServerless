...
class SNSUtilities {
    ...
    constructor(){
      ...
      let parameters = {
        apiVersion: 'latest',
        endpoint: global.SixCRM.configuration.site_config.sns.endpoint,
        region: global.SixCRM.configuration.site_config.sns.region || global.SixCRM.configuration.site_config.aws.region
      };
