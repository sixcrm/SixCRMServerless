...
class RedisUtilities extends AWSUtilities{
        ...
        return new Promise((resolve, reject) => {
          ...
          if(objectutilities.hasRecursive(this, 'redis_client.ready') && this.redis_client.ready == true){
            ...
            if(_.isNull(create_result) || create_result == false){
              ...
              du.info('redisUtilities.prepare attempting to connect ('+mathutilities.appendOrdinalSuffix(attempts)+' attempt...)');
    ...
    waitForClientReady(attempt){
      ...
      if(attempt < 21){
        ...
        du.info('Waiting for client to be ready ('+mathutilities.appendOrdinalSuffix(attempt)+' attempt...)');
