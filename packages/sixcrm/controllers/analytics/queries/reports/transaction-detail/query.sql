SELECT
  ...
  t.associated_transaction,
  a.alias AS associated_transaction_alias,
  COALESCE(a.amount, 0) AS associated_transaction_amount,
  t.merchant_provider,
...
LEFT JOIN analytics.f_transaction a ON a.id = t.associated_transaction
