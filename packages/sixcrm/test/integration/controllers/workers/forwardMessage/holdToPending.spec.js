...
describe('controllers/workers/forwardmessage/holdToPendingForwardMessage.js', () => {
	...
	describe('execute', () => {
		...
		it('successfully executes', () => {
			...
			let holdToPendingForwardMessageController = new HoldToPendingForwardMessageController();

			return holdToPendingForwardMessageController.execute().then(result => {
				du.info(result);
			});
