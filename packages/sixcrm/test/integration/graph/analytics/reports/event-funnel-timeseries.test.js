...
let test_name = 'Event funnel timeseries';

let test_query = global.SixCRM.routes.include('handlers', 'endpoints/graph/queries/analytics/reports/event-funnel-timeseries/event-funnel-timeseries.json');
