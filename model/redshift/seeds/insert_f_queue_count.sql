insert into f_queue_count(queuename,account,count,datetime)
  (
    ...
    UNION
    select 'bill','d3fa3bf3-7824-49f4-8261-87674482bf1c',212,date'2017-03-02T17:23:43.043Z'
    UNION
    select 'bill','d3fa3bf3-7824-49f4-8261-87674482bf1c',21,date'2017-03-02T00:23:43.043Z'
  )
    EXCEPT
